...
def eduroamcheck(request):
    ...
    try:
        ...
        return HttpResponse(json.dumps(result, cls=DjangoJSONEncoder), status=404, content_type='application/json')
    result = {
    ...
    try:
        ...
        pass
    return HttpResponse(json.dumps(result, cls=DjangoJSONEncoder), status=201, content_type='application/json')
